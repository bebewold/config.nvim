...
```sh
git clone https://git.bwdev.dev/bebewold/config.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://git.bwdev.dev/bebewold/config.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://git.bwdev.dev`/bebewold/config.nvim.git "${env:LOCALAPPDATA}\nvim"
```
